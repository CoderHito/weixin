...
//		{
//			me.afterLoadSetValueStatus = valueInit;  //0000 有bug
//		}
		
		if(tree.store.isLoading())
		{
			if(valueInit==''){
				me.afterLoadSetValueStatus = false;
			}else{
				me.afterLoadSetValueStatus = true;
...
//		me.setRawValue(valueFin.join(', '));
		if(me.multiselect == true){//mod zll
			me.value = valueInit;
			me.setRawValue(valueFin.join(', '));
		}else{
			me.value = value[0];
			me.setRawValue(valueFin[valueFin.length-1]);
	...
	initComponent: function() 
	{
		...
		me.tree = Ext.create('Ext.tree.Panel',
		{
			...
			listeners:
			{
				...
				{
					if(me.afterLoadSetValueStatus != false)
					{
