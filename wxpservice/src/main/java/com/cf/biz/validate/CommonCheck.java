...
public class CommonCheck {
	//private static final Logger logger = LoggerFactory.getLogger(CommonCheck.class);
	private final static Logger logger = Logger.getLogger(CommonCheck.class);
	//校验String是否为空
